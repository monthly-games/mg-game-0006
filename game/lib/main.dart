        ...
        return Scaffold(
          ...
          body: Center(
            child: Column(
              ...
              children: [
                const MGAdaptiveText('MG-0006 STABILIZED', style: TextStyle(fontSize: 24, color: Colors.white, fontWeight: FontWeight.bold)),
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            MGAdaptiveText('MG-0006 STABILIZED', style: TextStyle(fontSize: 24, color: Colors.white, fontWeight: FontWeight.bold)),
